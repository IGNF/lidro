...
def main(config: DictConfig):
    ...
    input_dir_points = os.path.join(output_dir, "points_skeleton")
    ...
    points_clip_list = [
        ...
        for filename in os.listdir(input_dir_points)
        if filename.endswith(".geojson")
        for _, row in gpd.read_file(os.path.join(input_dir_points, filename)).iterrows()
    ]
